...
let videoFg; const videoBg = document.querySelector('.videobg')
...
function loadTextures () {
  loadImages([{ name: 'dropAlpha', src: 'img/drop-alpha.png' }, { name: 'dropColor', src: 'img/drop-color.png' }]).then((images) => {
